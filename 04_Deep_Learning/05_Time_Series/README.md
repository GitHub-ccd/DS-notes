# Section 05 — Time Series

Time series fundamentals — datetime indexing, trends, seasonality, decomposition, and stationarity.

## Notebooks

| Notebook | Topic |
|----------|-------|
| `01_introduction_to_time_series.ipynb` | Datetime indexing in Pandas, resampling, rolling windows |
| `02_managing_time_series_data_lab.ipynb` | Managing time series data lab |
| `03_removing_trends_lab.ipynb` | Removing trends lab |
