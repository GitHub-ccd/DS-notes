...
Core Python for data science: scalar types, strings, collections, control flow, functions, and a capstone text analysis project. All lesson and lab content is integrated into single focused notebooks.
...
| `05_loops.ipynb` | for/while, enumerate/zip/range, break/continue, nested loops |
